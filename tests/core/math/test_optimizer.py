...
def create_default_line_search():
    ...
    return LineSearchFactory.create(
        "backtracking", f=test_objective_function, grad_f=test_gradient_function
    )
...
class TestNewtonOptimizer:
    ...
    def newton_optimizer(self):
        ...
        return NewtonOptimizer(
            lsolver=linear_solver, line_searcher=line_search, alpha0_func=default_alpha0_func
        )
...
class TestBFGSOptimizer:
    ...
    def bfgs_optimizer(self):
        ...
        return BFGSOptimizer(line_searcher=line_search, alpha0_func=default_alpha0_func)
...
class TestLBFGSOptimizer:
    ...
    def test_lbfgs_optimizer_convergence(self, lbfgs_optimizer, caplog):
        ...
        result = lbfgs_optimizer.optimize(
            x0=x0, f=test_objective_function, grad=test_gradient_function
        )
...
class TestOptimizerFactory:
    def test_optimizer_factory_create_default(self):
        ...
        optimizer_methods = ["default", "newton", "bfgs", "lbfgs"]
    ...
    def test_optimizer_registry(self):
        ...
        expected_methods = ["default", "newton", "bfgs", "lbfgs"]
