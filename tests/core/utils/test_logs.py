...
class TestCustomLogHandlers:
    ...
    def test_surrealdb_handler_initialization(self):
        """Test SurrealDBHandler initialization (requires mock SurrealDB client)."""
        mock_surrealdb_client = MagicMock()
        
        handler = SurrealDBHandler(mock_surrealdb_client)
