...
class TestMinioIntegratedBackend:
    ...
    def test_logging(self, minio_backend, caplog):
        ...
        # Check log records
        assert any('Message sent to topic' in record.message 
    ...
    def test_minio_presigned_url(self, minio_backend, backend_config):
        ...
        presigned_url = minio_backend.get_presigned_url(
            bucket, 
            object_name, 
            expiry=3600  # 1 hour
        )
