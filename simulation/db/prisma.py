...
class PrismaDB(DatabaseBase):
    ...
    async def connect_client(self):
        try:
            ...
            self.logger.error(
                SimulationLogMessageCode.COMMAND_FAILED.details(
                    f"Unexpected error during client connection: {e}"
                )
            )
            raise SimulationError(
                SimulationErrorCode.DATABASE_CONNECTION,
                "Unexpected error during client connection",
                details=str(e),
            )
    ...
    async def query(self, query: str) -> List[Dict[str, Any]]:
        ...
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(
                f"Query executed successfully: {query}"
            )
        )
        return result
    ...
    async def get_table(self, table: str) -> List[Dict[str, Any]]:
        ...
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(
                f"Records retrieved from table '{table}': {result}"
            )
        )
        return result
    ...
    async def get_tables(self) -> List[str]:
        ...
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(f"Tables in the database: {tables}")
        )
        return tables
    ...
    async def get_schema(self, table: str) -> Dict[str, Any]:
        ...
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(f"Schema of table '{table}': {schema}")
        )
        return schema
    ...
    async def create_table(self, table: str, schema: dict) -> None:
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(
                "Table creation is managed by Prisma. Skipping manual creation."
            )
        )
        pass
    ...
    async def delete_table(self, table: str) -> None:
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(
                "Table deletion is managed by Prisma. Skipping manual deletion."
            )
        )
        pass
    ...
    async def create_all_tables(self) -> None:
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(
                "Table creation is managed by Prisma. Skipping manual creation of all tables."
            )
        )
        pass
    ...
    async def delete_all_tables(self) -> None:
        self.logger.info(
            SimulationLogMessageCode.COMMAND_SUCCESS.details(
                "Table deletion is managed by Prisma. Skipping manual deletion of all tables."
            )
        )
        pass
