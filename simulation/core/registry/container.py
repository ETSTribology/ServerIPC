...
class RegistryContainer:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            default_registries = [
                ...
                (
                    "barrier_initializer",
                    "simulation.core.contact.barrier_initializer.BarrierInitializerBase",
                ),
            ...
            for registry_name, base_class_path in default_registries:
                try:
                    ...
                    base_class = getattr(__import__(module_name, fromlist=[class_name]), class_name)
            ...
            logger.debug("RegistryContainer instance created with all registries initialized.")
    ...
    def add_registry(self, registry_name: str, base_class_path: str):
        ...
        try:
            ...
            raise ImportError(f"Could not import base class for registry '{registry_name}': {e}")
