...
from core.solvers.line_search import LineSearchFactory
from core.solvers.linear import LinearSolverFactory
...
registry_container.add_registry("optimizer", "core.solvers.optimizer.OptimizerBase")
